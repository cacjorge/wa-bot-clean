...
exports.run = async (bot, message, args) => {
	if (message.isMedia && message.type === 'image' ) {
		...
		await bot.sendFileFromUrl(message.from, `https://some-random-api.ml/canvas/wasted?avatar=${imageUrl}`, 'Wasted.jpg', '', message.id)
...
exports.help = {
    name: "GTA WASTED",
    description: "Wastify a picture",
    usage: "wasted <image>/<quoted>",
    cooldown: 5
};
